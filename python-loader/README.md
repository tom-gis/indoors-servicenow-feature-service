...
- A new user-defined field 'u_level_id' must be added to the cmn_location table.
...
- If the Facilities layer contains any of the following fields related to address
  information, they will be used to populate fields in the ServiceNow location table:
  | Facilities Layer Attribute | ServiceNow Location Table Field | Data Type |
  |----------------------------|---------------------------------|-----------|
  | ADDRESS | street | Text |
  | LOCALITY | city | Text |
  | PROVINCE | state | Text |
